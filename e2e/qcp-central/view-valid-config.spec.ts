...
library.parseJson('./e2e/qcp-central/test-data/viewValid.json').then(function(data) {
  jsonData = data;
});

describe('Test Suite: QCP - View Valid Configurations', function () {
  ...
  it('Test Case 2: To Verify the ability to view Vitros specific configs', function () {
    ...
    viewValid.isColumnDisplayed(columnNameToFind2).then(function (displayed) {
      expect(displayed).toBe(false);
    });
    viewValid.isColumnDisplayed(columnNameToFind3).then(function (displayed) {
      expect(displayed).toBe(true);
    });
   ...
   it('Test Case 3: To Verify the ability to view Non - Vitros specific configs', function () {
    ...
    viewValid.isColumnDisplayed(columnName1).then(function (displayed) {
      expect(displayed).toBe(false);
    });
