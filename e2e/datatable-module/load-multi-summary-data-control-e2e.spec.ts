...
describe('Multi Summary Data Entry', function () {
  ...
  it('Load Multi Summary Control Level E2E', function () {
    library.logStep('Load Multi Summary Control Level E2E Start');
    ...
    newLabSetup.navigateTO(jsonData.Dept2Instrument1).then(function (navigate) {
      ...
      library.logStep('Load Multi Summary Control Level E2E End');
    });
  });
});
