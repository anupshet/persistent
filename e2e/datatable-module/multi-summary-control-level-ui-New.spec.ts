...
describe('Point Data Entry', function () {
  ...
  it('Test case 26: Clicking on Dont Save Data button ' +
       'on the modal when user tries to navigate away from data entry page will navigate you to the new location.', function () {
    library.logStep('Test case 26: Clicking on Dont Save ' +
       'Data button on the modal when user tries to navigate away from data entry page will navigate you to the new location.');
...
it('Test case 19:   Level Entry: For a level, errors should only be shown when user moves to next level using the tab key.', function () {
  ...
  library.logStep('Test case 21:Level Entry: For a level, ' +
       'if user inputs one field and moves to next level, errors should be displayed for empty field for that level using the tab key.');
  newLabSetup.navigateTO(jsonData.DepartmentName1).then(function (navigate) {
    expect(navigate).toBe(true);
  });
  newLabSetup.navigateTO(jsonData.InstrumentName1).then(function (navigate) {
...
it('Test case 20:  Run Entry: For a level, errors should only be shown when user moves to next level using the tab key.', function () {
  ...
  library.logStep('Test case 22:Run Entry: For' +
       ' a level, if user inputs one field and moves to next' +
       ' level, Errors should be displayed for empty ' +
       'field for that level.'); newLabSetup.navigateTO(jsonData.DepartmentName).then(function (navigate) {
