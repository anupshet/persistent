...
describe('Multi Point Data Entry', function () {
  ...
  it('Test case 21:Instrument:To Verify that a modal will be displayed if user clicks on any pagination button without saving data',
   function () {
    library.logStep('Test case 21:Instrument:To Verify that a modal will be displayed if user clicks on any pagination button without saving data');
    library.logStep('Test case 22:Instrument:Display of modal when user navigates away from data entry page');
    library.logStep('Test case 23:Instrument:Clicking on the Dont save data button on the modal when user tries to navigate away from data entry page will navigate you to the new location');
    library.logStep('Test case 24:Instrument:Clicking on the Save this page on the modal when user tries to navigate away from data entry page will save the data');
...
it('Test case 16:Control: To verify that Pagination buttons will be presented on the bottom of the page after 25th Analyte.', function () {
  ...
  library.logStep
  ('Test case 17:Control: To Verify that user will be navigated to specific page of analytes by clicking on Page number in Pagination Control');
...
('Test case 16:Instrument: To verify that Pagination buttons will be presented on the bottom of the page after 25th Analyte.', function () {
  library.logStep('Test case 16:Instrument: To verify that Pagination buttons will be presented on the bottom of the page after 25th Analyte.');
  library.logStep
  ('Test case 17:Instrument: To Verify that user will be navigated to specific page of analytes by clicking on Page number in Pagination Control');
  library.logStep('Test case 18:Instrument: To Verify that Clicking on Single arrow (Next) will be taking user to very next page of Analytes');
  library.logStep('Test case 19:Instrument: To Verify that once the user Navigated to the second page Previous arrow button will be enabled.');
