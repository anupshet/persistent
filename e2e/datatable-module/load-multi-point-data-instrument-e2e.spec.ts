...
describe('Multi Point Data Entry', function () {
  ...
  it('Load Multi Point Instrument Level E2E', function () {
    library.logStep('Load Multi Point Instrument Level E2E Start');
    ...
    library.logStep('Load Multi Point Instrument Level E2E End');
  });
