...
library.parseJson('./JSON_data/WR8x_2.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 8x', function () {
  ...
  it('Test Case 12: To check if the Rejection is shown for the multilevel data which violates the 8x rule for values below Mean (Across runs)',
    function () {
