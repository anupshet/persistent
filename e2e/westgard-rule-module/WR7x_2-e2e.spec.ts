...
library.parseJson('./JSON_data/WR7x_2.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 7x', function () {
  ...
  it('Test Case 9:- To check if the Rejection is shown for the data which violates the 7x rule for values above Mean (within run)',
    function () {
