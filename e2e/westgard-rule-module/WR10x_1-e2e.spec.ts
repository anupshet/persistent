...
library.parseJson('./JSON_data/WR10x_1.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 10x', function () {
  ...
  it('Test Case 2: To check if the Warning is shown for the data which violates the 10x rule for values above Mean (within run)',
    function () {
