...
library.parseJson('./JSON_data/WR8x_3.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 8x', function () {
  ...
  it('Test Case 17: To verify that any value above Mean can be added for multilevel data after disabling the 8x Rule (Across runs)',
    function () {
