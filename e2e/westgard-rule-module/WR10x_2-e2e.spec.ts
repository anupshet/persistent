...
library.parseJson('./JSON_data/WR10x_2.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 10x', function () {
  ...
  it('Test Case 12: To check if the Rejection is shown for the multilevel data which violates the 10x rule for values below Mean (Across runs)',
    function () {
