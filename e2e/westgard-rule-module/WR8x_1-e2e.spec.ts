...
library.parseJson('./JSON_data/WR8x_1.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 8x', function () {
  ...
  const library = new BrowserLibrary();
  let multiplyL1, multiplyL2, firstAddL1, firstAddL2, secondAddL1, thirdAddL1, fourthAddL1, l1Value;
  ...
  it('Test Case 2: To check if the Warning is shown for the data which violates the 8x rule for values above Mean (within run)',
    function () {
