...
library.parseJson('./JSON_data/WR7x_3.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 7x', function () {
  ...
  it('Test Case 17: To verify that any value above Mean can be added for multilevel data after disabling the 7x Rule (Across runs)',
    function () {
