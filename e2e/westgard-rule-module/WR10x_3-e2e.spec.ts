...
library.parseJson('./JSON_data/WR10x_3.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 10x', function () {
  ...
  let multiplyL1, multiplyL2, firstAddL1, firstAddL2, secondAddL1, secondAddL2,
    thirdAddL1, thirdAddL2, l1Value, l2Value;
  ...
  it('Test Case 17: To verify that any value above Mean can be added for multilevel data after disabling the 10x Rule (Across runs)',
    function () {
