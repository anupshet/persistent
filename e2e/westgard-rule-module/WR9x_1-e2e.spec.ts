...
library.parseJson('./JSON_data/WR9x_1.json').then(function(data) {
  jsonData = data;
});
describe('Westgard Rules:- 9x', function () {
  ...
  it('Test Case 5:- To check if Warning is shown for multilevel data which violates 9x rule for values below Mean (Across runs)',
    function () {
