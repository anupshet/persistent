...
library.parseJson('./JSON_data/WR9x_3.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 9x', function () {
  ...
  it('Test Case 17: To verify that any value above Mean can be added for multilevel data after disabling the 9x Rule (Across runs)',
    function () {
