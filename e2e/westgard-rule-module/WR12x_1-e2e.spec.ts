...
library.parseJson('./JSON_data/WR12x_1.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 12x', function () {
  ...
  it('Test Case 5: To check if the Warning is shown for the multilevel data which violates 12x rule for values below Mean (Across runs)',
    function () {
