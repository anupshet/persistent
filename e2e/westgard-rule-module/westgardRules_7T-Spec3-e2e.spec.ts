...
library.parseJson('./JSON_data/WR7T-Spec3.json').then(function(data) {
  jsonData = data;
});



describe('Test Suite: Westgard Rules_7T_R4S', function () {
  ...
  it('Test case 13: To verify if any value can be entered after disabling 7T Rule', function () {
