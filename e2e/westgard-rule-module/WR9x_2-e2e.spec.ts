...
library.parseJson('./JSON_data/WR9x_2.json').then(function(data) {
  jsonData = data;
});
...
describe('Westgard Rules:- 9x', function () {
  ...
  it('Test Case 9:- To check if the Rejection is shown for the data which violates the 9x rule for values above Mean (within run)',
    function () {
