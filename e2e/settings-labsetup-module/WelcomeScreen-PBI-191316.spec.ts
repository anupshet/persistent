...
describe('Test Suite: PBI 191316 - Implement Welcome screen with the listed selections for the initial lab setup', function () {
  ...
  it('Test Case 1 : Verify welcome screen UI is displayed for the new account' +
    'Test Case 2 : To verify options are selected by default on welcome screen' +
    'Test Case 3 : Verify "Lets Go" button is enabled by default', function () {
  ...
  it('Test Case 4 : To verify data entry type selected on welcome screen reflects on control and analyte setting screen' +
    'Test Case 5 : Verify Select reagent and calibrator lot checkboxes on add analyte are not displayed' +
    'when "Unity can track..." option is selected to Yes on welcome screen', function () {
  ...
  it('Test Case 6 : Verify selected decimal places at welcome screen are displayed on control/analyte setting page', function () {
    labsetup.navigateTO(jsonData.Dept).then(function (navigated) {
      expect(navigated).toBe(true);
    });
    labsetup.navigateTO(jsonData.Instrument1Model).then(function (navigated) {
  ...
  it('Test Case 7 : To verify selected options reflects on control and analyte at add or settings page' +
    'Test Case 8 : Verify "We have no departments" option allows to add instrument without department', function () {
