...
library.parseJson('./JSON_data/copy-instrument-pbi-197745_qa.json').then(function(data) {
  jsonData = data;
});


describe('Test Suite PBI 197745: Copy Instrument within same department', function () {
  ...
  afterEach(function () {
    ...
    it('Test case 1: To verify Copy Instrument within same department functionality', function () {
      library.logStep('Test case 1: To verify Copy Instrument within same department functionality');
      ...
      setting.selectToDepartment(jsonData.Department).then(function (selectedDept) {
  ...
  it('Test case 8: To verify that the Instrument created using Copy Instrument functionality is available for Mapping using Connectivity',
    function () {
      ...
      connectivity.applyDepartmentFilter(jsonData.Department).then(function (filter) {
