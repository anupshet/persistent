...
library.parseJson('./JSON_data/copy-instrument-pbi-197745.json').then(function(data) {
  jsonData = data;
});

describe('Test Suite PBI 197745: To verify Copy Instrument functionality for a Lab without Dept', function () {
...
/*
  it('Test case 1: To verify Copy Instrument functionality for a Lab without Dept', function () {
    library.logStep('Test case 1: To verify Copy Instrument functionality for a Lab without Dept');
