...
library.parseJson('./JSON_data/copy-instrument-pbi-197746.json').then(function(data) {
  jsonData = data;
});
describe('Test Suite PBI 197746: Copy Instrument to another department, source instrument does not exist at destination', function () {
  ...
  it('Test case 1: To verify Copy Instrument Across department functionality', function () {
    library.logStep('Test case 1: To verify Copy Instrument Across department functionality');
