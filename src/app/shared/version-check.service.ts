...
import { AuditTracking, AuditTrackingAction, AuditTrackingActionStatus } from './models/audit-tracking.model';
  ...
  public checkVersion(url) {
    ...
    this.http.get(url + '?t=' + new Date().getTime())
      .subscribe(
        ...
        (err) => {
          // Log that there was no version.json found
          const _auditTracking: AuditTracking = {
            action: AuditTrackingAction.NoVersionJsonFound,
          ...
          // Logout due to no version.json found
