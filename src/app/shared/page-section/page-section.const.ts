...
import { AnalyteEntry, AnalyteView, GlobalLabels, ReagentCategory } from 'br-component-library';
import { orderBy, cloneDeep } from 'lodash';

import { AnalyteSection, InstrumentSection } from '../../contracts/models/data-management/page-section/instrument-section.model';
...
import { LabAccessPermissions } from '../../security/model/permissions.model';

export const mockInstrumentSection: InstrumentSection = {
  instrument: null,
  productSections: [{
    'product': {
      'displayName': 'Anemia',
      'productId': '1',
      'productMasterLotId': '47',
      'productCustomName': '',
      'productInfo': {
        'id': 1,
        'name': 'Anemia',
      ...
      'lotInfo': {
        ...
        'productName': 'Anemia',
        'lotNumber': '43290',
        'expirationDate': new Date('2021-09-30T00:00:00')
      },
      'productLotLevels': [{
        'id': '61',
        'productMasterLotId': '47',
        'productId': '1',
        'productMasterLotNumber': '43290',
        'lotNumber': '43290',
        'level': 1,
        'levelDescription': '1'
      }],
      'levelSettings': {
        ...
        'parentLevelEntityId': '3050115e-4a75-4d83-9492-8f14441c568d',
        ...
        'id': '48bc3445-d38c-b389-e66c-324a29d56bbd',
        'parentNodeId': '3050115e-4a75-4d83-9492-8f14441c568d',
        'parentNode': null,
        'nodeType': 8,
        'displayName': '48bc3445-d38c-b389-e66c-324a29d56bbd',
        'children': null,
      },
      ...
      'isArchived': false,
      'sortOrder': 0,
      'id': '3050115e-4a75-4d83-9492-8f14441c568d',
      'parentNodeId': '6c848421-f116-4c4d-a680-b7f978ae334e',
      'parentNode': null,
      'nodeType': 5,
      'children': [{
        'displayName': 'Ferritin',
        'testSpecId': '5202',
        'correlatedTestSpecId': '97F46DB8B253436BAA586DD7F3207545',
        'testId': '5184',
        'labUnitId': '51',
        'testSpecInfo': {
          'id': 5202,
          'testId': 5184,
          'analyteStorageUnitId': 72,
          'analyteId': 67,
          ...
          'reagentName': 'Ferritin REF 07P65',
          'reagentLotId': 1549,
          ...
          'reagentLot': {
            ...
            'reagentCategory': ReagentCategory.Generic,
            'shelfExpirationDate': new Date('2069-05-24T19:50:56.423')
          },
          'storageUnitId': 2,
          ...
          'calibratorName': 'Ferritin Cal REF 07P6501',
          'calibratorLotId': 810,
          ...
          'calibratorLot': {
            ...
            'calibratorId': 808,
            'lotNumber': 'Unspecified ***',
            'shelfExpirationDate': new Date('2069-05-24T19:50:56.427')
          }
        },
        'levelSettings': {
          'levelEntityId': null,
          'levelEntityName': 'LevelSetting',
          'parentLevelEntityId': 'd3047cda-8b7e-4bbb-bab4-22c377481d0a',
          ...
          'id': '04bc3446-0e1f-55a0-a630-6888ac7eaf09',
          'parentNodeId': 'd3047cda-8b7e-4bbb-bab4-22c377481d0a',
          'parentNode': null,
          'nodeType': 8,
          'displayName': '04bc3446-0e1f-55a0-a630-6888ac7eaf09',
          'children': null
        },
        'accountSettings': null,
        'hasOwnAccountSettings': false,
        ...
        'isArchived': false,
        'sortOrder': 2,
        'id': 'd3047cda-8b7e-4bbb-bab4-22c377481d0a',
        'parentNodeId': '3050115e-4a75-4d83-9492-8f14441c568d',
        'parentNode': null,
        'nodeType': 6,
        'children': [],
    ...
    'analyteSections': [{
      'analyteInfo': {
        ...
        'levelsInUse': [1],
        'decimalPlaces': [2],
        'instrumentId': '6c848421-f116-4c4d-a680-b7f978ae334f',
        'productId': '3050115e-4a75-4d83-9492-8f14441c568d',
        'testName': 'XYZ',
        'labTestId': 'd3047cda-8b7e-4bbb-bab4-22c377481d0c',
        'correlatedTestSpecId': '97F46DB8B253436BAA586DD7F3207546',
        'testSpecId': '5202',
        'isSummary': true,
        'productMasterLotId': '47',
        'productMasterLotExpiration': new Date('2021-09-30T00:00:00'),
        'codeListTestId': 5202,
        'labUnitId': 51,
        'defaultReagentLot': {
          'id': 1549,
      ...
      'analyteInfo': {
        ...
        'levelsInUse': [1],
        'decimalPlaces': [2],
        'instrumentId': '6c848421-f116-4c4d-a680-b7f978ae334e',
        'productId': '3050115e-4a75-4d83-9492-8f14441c568d',
        'testName': 'Ferritin',
        'labTestId': 'd3047cda-8b7e-4bbb-bab4-22c377481d0a',
        'correlatedTestSpecId': '97F46DB8B253436BAA586DD7F3207545',
        'testSpecId': '5202',
        'isSummary': true,
        'productMasterLotId': '47',
...
export const mockPageSectionService = {
  extractCumulativeLevelsInUse() { return new Array<number>(); },
  getGlobalLabels() { return new GlobalLabels(); },
  extractAnalyteSectionsFromInstrumentSection() { return new Array<AnalyteSection>(); },
  createAnalyteEntrySets() { return Array<AnalyteEntry>(); },
  createAnalyteViewSets() { return Array<AnalyteView>(); },
  extractValidAnalyteEntries() { return Array<AnalyteEntry>(); },
  createPostBaseRawDataSet() { },
  populateTranslationLabelDictionary() { },
  extractSortedProductSections(instrumentSection) {
    const productSections = cloneDeep(instrumentSection.productSections);
  ...
  extractSortedAnalyteSectionsByProduct(productSections) {
    let combinedAnalyteSections = new Array<AnalyteSection>();
    ...
    combinedAnalyteSections = orderBy(combinedAnalyteSections, [(analyteSection) => analyteSection.analyteInfo.sortOrder,
    (analyteSection) => analyteSection.analyteInfo.testName.replace(/\s/g, '').toLocaleLowerCase()], [asc, asc]);
    return combinedAnalyteSections;
  },
  getIsSummaryOnly() { return false; }
};

export const mockLabDataApiService = {
  getSummaryDataByLabTestIdsAsync() { return new Promise<SummaryDataModel[]>(null); },
  getSummaryDataByLabTestIds() { return new Promise<Array<number>>(null); },
  postDataBatchAsync() { return new Promise<Array<BaseRawDataModel>>(null); }
};

export const mockCodelistApiService = {
  getTestByIdAsync() { },
  getTestSpecByIdAsync() { },
  getUserActionsAsync() { return new Promise<Array<UserAction>>(null); }
};

export const mockUIConfigAction = jasmine.createSpyObj([
  'updateTabOrderState'
]);

export const mockDataManagementSpinnerService = {
  displaySpinner(isDisplay: boolean): void { }
};

export const mockRunsService = jasmine.createSpy('getTranslation', () => { });
export const mockErrorLoggerService = jasmine.createSpyObj([
  'logErrorToBackend',
  'populateErrorObject'
]);
export const mockNavigationService = jasmine.createSpyObj([
  'navigateToUrl',
  'routeTo',
...
export class MockNotificationService {
  ...
  public unSubscribeLabTestFromHub() { }
}
export const mockDateTimeHelper = jasmine.createSpyObj(['getTimeZoneOffset', 'isExpiredOnSpecificDate']);
export const mockStore = {
  ...
  auth: {
    ...
    currentUser: {
      ...
      permissions: LabAccessPermissions,
      userData: {},
...
export const mockAnalyteEntry = {
  isRunEntryMode: false,
  analyteIndex: 1,
...
export const mockRawdata = {
  ...
  'isLastMatch': false,
  'id': '523496',
  'labTestId': '8897ced3-5814-4e0f-bec9-b95cac0d455d',
  'codeListTestId': 387,
  'labUnitId': 56,
  'testSpecId': 388,
  'dataType': 0,
  ...
  'rawDataDateTime': new Date('2020-09-02T05:52:50.525Z'),
  'localRawDataDateTime': new Date('2020-09-02T05:52:50.525Z'),
  'localRunDateTime': new Date('2020-09-02T11:22:50.525Z'),
  'runDateTime': new Date('2020-09-02T05:52:50.525Z'),
  'enteredDateTime': new Date('2020-09-02T05:52:54.272825Z'),
  'userActions': null,
  'userComments': null,
  'userInteractions': [
    {
      'interactionType': null,
      'userId': '00u7z65lnq6D9O2TB2p7',
      'userFullName': 'Mahesh Janugade',
      'enterDateTime': new Date('2020-09-02T05:52:54.272825Z')
    }
  ],
  'results': [],
  'evaluationRules': [
...
export const mockInprogressMessageService = {
  setProgressMessage: () => {
    return { progressHeader: null, progressMessage: null };
  },
  getTranslatedInprogressTexts: () => { }
};
