...
import { AnalyteEntry, BaseSummary, BrAnalyteSummaryEntryComponent, ChangeLotModel, LevelValue } from 'br-component-library';

import { DataEntryEditComponent } from './data-entry-edit.component';
...
describe('DataEntryEditComponent', () => {
  let component: DataEntryEditComponent;
  let fixture: ComponentFixture<DataEntryEditComponent>;
  ...
  const mockPageSectionService = {
    ...
    getLotsByTestSpecIdAsync: () => new ChangeLotModel()
  };
  ...
  const mockCodeListApiService = jasmine.createSpyObj('CodeListAPIService', {
    getTestSpecInfoFromCodeListAsync: {
...
/*   beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [DataEntryEditComponent, BrAnalyteSummaryEntryComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(DataEntryEditComponent);
    component = fixture.componentInstance;
    component.data = new AnalyteEntry();
    component.data.levelDataSet = [new LevelValue()];
    component.data.levelDataSet[0].data = new BaseSummary();
    component.data.levelDataSet[0].data.mean = 1;
    component.data.levelDataSet[0].data.sd = 1;
  ...
  it('should call logErrorToBackend', () => {
    const spyOnErrorLog = spyOn(mockErrorLoggerService, 'logErrorToBackend');
    component.data.levelDataSet[0].data = null; // Setting data to null will produce error which will call logErrorToBackend method
    component.ngOnInit();
