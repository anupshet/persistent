...
import { AnalyteDataEntryComponent } from './analyte-data-entry.component';
import { InstrumentSection } from '../../../contracts/models/data-management/page-section/instrument-section.model';
...
describe('AnalyteDataEntryComponent', () => {
  let component: AnalyteDataEntryComponent;
  let fixture: ComponentFixture<AnalyteDataEntryComponent>;
  ...
  const mockStore = {
    ...
    location: {
      currentLabLocation: {
        ...
        labLocationContact: {
          entityType: 0,
          searchAttribute: 'sanjay_chavan+dev006@bio-rad.com',
          firstName: 'Sanjay',
          middleName: '',
          lastName: 'Chavan',
          name: 'Sanjay Chavan',
          email: 'sanjay_chavan+dev006@bio-rad.com',
          phone: '',
  ...
  class MockRouterServices {
    ...
    public events = of(new NavigationEnd(0, this.url, this.url));
  }

  const ApiServiceStub = {
    getGrandChildren: (string): Observable<any> => {
      return of(new InstrumentSection);
    },
    getLabSetupAncestors: (nodeId: string) => of()
  };
  ...
  class FakePageSectionComponent {
  ...
  class FakeSinglePageSectionComponent {
    @Input() instrumentSection: InstrumentSection;
    @Input() entityType: EntityType;
  ...
  class FakeAnalyteDetailTableComponent { }
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        ...
        FakePageSectionComponent,
        FakeSinglePageSectionComponent,
        FakeAnalyteDetailTableComponent
      ],
      providers: [
        MockStore,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AnalyteDataEntryComponent);
  ...
  it('should create', () => {
    mockStore.DataManagement.cumulativeAnalyteInfo[0].isSummary = true;
    store.setState(mockStore);
    component.ngOnInit();
    expect(component).toBeTruthy();
  });

  it('should create when selected control', () => {
    mockStore.DataManagement.entityType = 5;
    mockStore.DataManagement.entityId = mockStore.navigation.selectedNode.id;
    mockStore.DataManagement.entityName = mockStore.navigation.selectedNode.displayName;
    store.setState(mockStore);
    component.ngOnInit();
    expect(component).toBeTruthy();
  });

  it('should create when selected instrument', () => {
    mockStore.DataManagement.entityType = 4;
    mockStore.DataManagement.entityId = '1111-1111-1111-1111';
    mockStore.DataManagement.entityName = 'test instrument';
    store.setState(mockStore);
    component.ngOnInit();
    expect(component).toBeTruthy();
  });
