...
import { HeaderService } from '../connectivity/shared/header/header.service';
...
@Component({ selector: 'unext-header', template: '' })
class HeaderStubComponent { }

@Component({ selector: 'unext-router-outlet', template: '' })
      ...
      TestBed.configureTestingModule({
        ...
        providers: [
          ...
          { provide: DataManagementService, useValue: fakedataManagementService },
          {
            ...
            useValue: { getTreeNodes: () => of({}), getNavState: () => of({}), getNavOpenState: () => of({}) }
          },
