...
import { AnalyticalSectionComponent } from './analytical-section.component';
import { HttpLoaderFactory } from '../../../../app.module';
import * as fromRoot from '../../../../state/app.state';
import { SortByPipe } from '../../shared/pipes/sort-by.pipe';

describe('AnalyticalSectionComponent', () => {
  let component: AnalyticalSectionComponent;
  let fixture: ComponentFixture<AnalyticalSectionComponent>;
  const mockUIConfSvc = {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AnalyticalSectionComponent);
  ...
  it('should toggle chart', () => {
    ...
    fixture.detectChanges();
    const spyObj = spyOn(component, 'toggleChart').and.callThrough();
    const event = new Event('change');
    const checkBoxElem = <HTMLElement>fixture.debugElement.nativeElement.querySelector('.spec_toggle_chart');
  ...
  it('should toggle summary', () => {
    component.visible = true;
    component.isSummary = false;
    fixture.detectChanges();
    const spyObj = spyOn(component, 'toggleSummary').and.callThrough();
    const event = new Event('change');
    const checkBoxElem = <HTMLElement>fixture.debugElement.nativeElement.querySelector('.spec_toggle_summary');
    checkBoxElem.dispatchEvent(event);
    fixture.whenStable().then(() => {
      expect(spyObj).toHaveBeenCalled();
    });
  ...
  it('should toggle div', () => {
    const spyObj = spyOn(component, 'toggleDiv').and.callThrough();
    const event = new Event('click');
    const divElem = <HTMLElement>fixture.debugElement.nativeElement.querySelector('.spec_toggle_div');
