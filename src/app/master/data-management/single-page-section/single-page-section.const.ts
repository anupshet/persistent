...
import { ITranslationConfig } from '../../../contracts/models/translation/translation-config.model';
...
export const mockCodelistApiService = {
  ...
  getTestById: () => { },
  getTestSpecById: () => { },
  getTestInfoFromCodeListAsync: () => ({ reagentId: '', calibratorId: '' }),
  getTestSpecInfoFromCodeListAsync: () => ({ reagentId: '', calibratorId: '' }),
  getReagentLotsByReagentIdAsync: () => { },
...
export const mockAuthenticationService = jasmine.createSpy('getCurrentUser', () => { });
export const mockDataManagementService = {
  getPortalProductByLabInstrumentProductLotIdAsync: () => { },
  extractInteractions: () => { }
};
export const mockLabTestService = jasmine.createSpyObj([
  'getLabTest',
  'putLabTest',
  'postLabTest'
]);
...
export const mockMatDialog = jasmine.createSpyObj(['open', 'close', 'closeAll']);
export const mockNavigationService = {
  navigateToUrl: () => { }
};
export const mockTranslationService = {
  getTranslatedMessage: (translationConfig: ITranslationConfig, key: string) => {
    return key;
  },
};
export const mockLabDataApiService = {
  getLatestSummaryDataByLabTestIdAsync: (labTestId: string, rawDataDateTime?: Date) => {
    return of(null).toPromise();
  },
  getRunDataByLabTestIdsAsync: () => {
    return of(new Array<RunData>()).toPromise();
  },
  putDataJson: () => {
    return of(null);
  },
...
export const mockDateTimeHelper = jasmine.createSpyObj([
  'getTimeZoneOffset',
...
export const mockSummaryStatService = {
...
export const baseRawDataSet = [
  {
    'localSummaryDateTime': new Date('2021-04-30T23:59:59.999Z'),
    'userActions': null,
    'userComments': null,
    'userInteractions': [
      {
        ...
        'enterDateTime': new Date('2021-05-19T11:18:27.706306Z')
      }
    ],
    'results': [],
    'upsertOptions': {
      'forceRuleEngineReEval': false,
      'isInsertOperation': false
    },
    'dataSource': 0,
    'id': '130317',
    'labTestId': '76bcb232-590c-47a3-668e-1ac39f59e065',
    'labUnitId': 56,
    'testSpecId': 3381,
    'dataType': 1,
    'rawDataDateTime': new Date('2021-04-30T18:29:59.999Z'),
    'localRawDataDateTime': new Date('2021-04-30T23:59:59.999Z'),
    'testId': 123,
...
export const analyteViewSets = [
  {
    ...
    'analyteName': 'Amylase, Pancreatic',
    'analyteDateTime': new Date('2021-04-30T18:29:59.999Z'),
    'analyteDateTimeOffset': '+05:30',
    'isSummary': true,
    'userActions': null,
    'userComments': null,
    'userInteractions': [
